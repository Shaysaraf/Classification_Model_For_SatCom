...
# --- FIXED IMPORTS FOR VITIS-AI / VART DEPLOYMENT ---
...
class TrainConfig:
    ...
    seed: int = 42
    save_dir: str = "models_results_resnet18"
...
class Trainer:
    ...
    def fit(self, name="ResNet18_DPU"):
...
def main():
    ...
    # --- FIXED MODEL INSTANTIATION FOR VART / VEK280 ---
    # Maps input spatial configuration to (1, segment_length) for static pooling evaluation
    model = resnet18(
    ...
    best_accuracy = trainer.fit("ResNet18_DPU")
